...
>- Ative o ambiente virtual de acordo com o SO usado. WINDOWS: No CMD, use ".ven\Scripts\activate.bat", E no PowerShell, use ".venv\Scripts\Activate.ps1". No LINUX: "source .venv/bin/activate". Se o ambiente for ativado corretamente o Terminal mostrará ***(.venv)*** antes do prompt.  
